...
def create_sample_data():
    ...
    price_data = pd.DataFrame({
        ...
        'RICE_PRICE': [2000, 2100, 2050, 2200, 2150, 2300],
        'WHEAT_PRICE': [1900, 1950, 2000, 2050, 2100, 2150],
        'COTTON_PRICE': [5000, 5200, 5100, 5300, 5400, 5500],
        'SUGARCANE_PRICE': [300, 310, 315, 320, 330, 340]
    })
    ...
    yield_data = pd.DataFrame({
        ...
        'RICE_YIELD': [2500, 2600, 2550, 2700, 2650, 2800],
        'WHEAT_YIELD': [3000, 3100, 3050, 3200, 3150, 3300],
        'COTTON_YIELD': [1500, 1550, 1520, 1600, 1580, 1650],
        'SUGARCANE_YIELD': [60000, 62000, 61000, 63000, 62500, 65000]
    })
    ...
    area_data = pd.DataFrame({
        ...
        'RICE_AREA': [2000000, 2100000, 2050000, 2200000, 2150000, 2300000],
        'WHEAT_AREA': [1800000, 1850000, 1820000, 1900000, 1880000, 1950000],
        'COTTON_AREA': [900000, 920000, 910000, 950000, 930000, 960000],
        'SUGARCANE_AREA': [500000, 520000, 510000, 540000, 530000, 550000]
    })
